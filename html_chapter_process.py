...
os.chdir(desktop)
#print(desktop)
rawtext = textract.process(desktop + "/妄想限界：白夜今明.docx")
...
text = rawtext
text = re.sub(r'\n\n', '<br>', text)
text = re.sub(r'\[角色<\]', '<h2><span class="leadingtext">', text)
text = re.sub(r'\[角色>\]', '</h2></span>', text)
text = re.sub(r'\[角色名<\]', '<h2><span class="leadingtext">', text)
text = re.sub(r'\[角色名>\]', '</h2></span>', text)
text = re.sub(r'\[J<\]', '<h2><span class="leadingtext">', text)
text = re.sub(r'\[J>\]', '</h2></span>', text)
