...
&nbsp;&nbsp;&nbsp;&nbsp;*“在平淡、乏味，且完全遵循规律的日常里，你迎来了属于自己的死亡。”*
...
&nbsp;&nbsp;&nbsp;&nbsp;但魔界的使者，被称为亚米的魔神，将你送至了通往神庭的传送门。他将那则秘密告知予你：如果想要违抗自己的死亡，夺得更久的生命……——那就，前往天界的生命树庭园吧。
...
&nbsp;&nbsp;&nbsp;&nbsp;每当准备完毕，你便可以在地图中展开探索。找到开启下一关的按钮，迎来新一轮的试炼。寻找额外的奖励关卡，获得强力的永久可穿戴装备。

&nbsp;&nbsp;&nbsp;&nbsp;你的背包与奖励关卡通关状况都会被保存，但主线进度将会在退出游戏时清空。尽管如此，你依然可以使用“跳关”功能前往自己想要去的章节起点。

&nbsp;&nbsp;&nbsp;&nbsp;这座生命树庭园的终点究竟存在着什么？所谓的沙利叶的试炼又是否为真？在神庭的秩序被某种邪恶的力量颠覆时，你才将窥见这场“试炼游戏”的真相。
...
|**曲谱**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    | *蛮力*&nbsp;&nbsp;&nbsp;&nbsp;|  *守护*&nbsp;&nbsp;&nbsp;&nbsp;|  *坚韧*&nbsp;&nbsp;&nbsp;&nbsp;|  *敏捷*&nbsp;&nbsp;&nbsp;&nbsp;|  *汲冉*&nbsp;&nbsp;&nbsp;&nbsp;|  *烈躁*&nbsp;&nbsp;&nbsp;&nbsp;|  *冲斥*&nbsp;&nbsp;&nbsp;&nbsp;|* 获取方式&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| 
| :-------  ---- | -- | -- | -- | -- | -- | -- | -- |: -- |
|  活尸死体的安魂曲    |× |1~2 |1~2 |× |× |× |× |在**维修层**的服务器总站，<br>解锁*塞壬的指引*，直接解锁本乐谱。|
|  幽邃狭隙的民族歌    |1~2 |× |× |1~2 |× |× |× |在**维修层**竖井处，<br>输入密码，进入**支架**隐藏区域。|
|  稀琅空窿的清唱      |× |× |× |× |1~3 | 1~3|× |在**维修层**饮水机房处，<br>输入密码，通过碎裂的墙壁。|
|  白骸千疮的颂歌      | ×|× | ×|1~3 | 1~3| ×|× |在**物资层**东冷冻库南侧，<br>完成点灯解谜。|
|  霜炽烟浑的迷幻舞曲  | ×| ×|1~3 |× | ×| ×|1~3 |在**物资层**东冷冻库东侧，<br>使用白桦拉杆打开铁门。|
|  懈职怠策的爵士乐    |1~3 |× |× |× | ×|1~3 |× |在**主平台甲板**东南侧，<br>使用炸弹炸毁粘液墙。|
|  擅始惚终的提琴独奏  | 1~3|1~3 |× | ×| ×| ×|× |在**建材物资附属平台**，<br>找到一架粘液墙后的隐藏梯子，<br>前往上方甲板。|
|  沧没辙合的华尔兹    |× | ×|× |3~4 | ×|3~4 |× |在**水下研究设施·冷凝系统**<br>西北侧通过蓄水池进入排水管道，<br>游泳前往东南侧隐藏房间。|
|  穹坠诱祸的赞美诗    |× | 3~4|× |x | 3~4|x |× |在**通讯平台·工程区**<br>探索工程区剩余地带，<br>仔细检查仪式的小房间。|
|  漆海命墓的谣曲    |3~4 | ×|3~4 |x | ×|x |× |在**水下研究设施·矿物处理区**<br>解开通往矿物处理区深处的记忆锁。|
...
- 趋蕴魔板
    - 使得你蹲下后能够跳得更高。
    - 在技能发动时，手持撬棍将能够临时制造类似重锤的攻击效果。
    - 可以通过点击背包内的*趋蕴魔板*禁用此技能。
...
<br>
| 德怀特| 忒尔克西钻井平台的厨师，厨师幸存小队的成员。<br>由于瑞佛特主厨失去理智，被瑞佛特设计杀害后，尸体被瑞佛特食用。<br>如今作为特殊的骷髅型态尸变体，在物资层神出鬼没地四处活动。|
...
- 花园1（亚兹列尔的中庭花园）
    ...
    - 通过检测附近方块实现的最后存档点保存功能。
    - 使用展示实体、隐形怪物、区域事件实现的可破坏的地形陷阱。
    - 玩家背包合成区储存剧情物品。
...
- 前缀fp/的拓展功能数据包
    ...
    - 直线移动、随机漂移、画圈、螺线等移动方式。
    - 召唤实体时自动初始化特定分数与接口。
    - 容量6561函数的三叉树。
- 24点小游戏
    - 通过玩家在书与笔中自主写下公式判断答案是否成立。
