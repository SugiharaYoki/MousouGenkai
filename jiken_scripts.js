...
const chapters = [
  ...
  {
    title: "殆命睹始的时钟博物馆「Balance：逆命谐振」",
    shortTitle: "第壹篇章 简介",
    filePath: "jiken_chapter2.txt",
    id: 2,
    summary: "水无波澜的时日，私家侦探八月朔日怜隐接下一桩旧友委托的校园案件。<br>身为班花的夏川梨绘接连数天收到威胁骚扰信息，且住址也已暴露。为维护学生颜面，班主任池田达平委托怜隐对此进行调查。<br><br>在身为受害者同班同学的神山雏子帮助下，案件的可能性很快便被缩小至极易推理的范畴。可原本并非难案的本次私人委托，却因某位曾试图寻求怜隐帮助的富豪雇主意外身亡而逐渐转为错综复杂的悬案。<br>市原近郊的六道家族时钟博物馆，子时即将到来之刻，怜隐将被迫踏上一场扑朔迷离的旅途。",
  },
  {
    title: "殆命睹始的时钟博物馆「Escapement：再始曳光」",
    shortTitle: "第壹篇章 简介",
    filePath: "jiken_chapter3.txt",
    id: 3,
    summary: "水无波澜的时日，私家侦探八月朔日怜隐接下一桩旧友委托的校园案件。<br>身为班花的夏川梨绘接连数天收到威胁骚扰信息，且住址也已暴露。为维护学生颜面，班主任池田达平委托怜隐对此进行调查。<br><br>在身为受害者同班同学的神山雏子帮助下，案件的可能性很快便被缩小至极易推理的范畴。可原本并非难案的本次私人委托，却因某位曾试图寻求怜隐帮助的富豪雇主意外身亡而逐渐转为错综复杂的悬案。<br>市原近郊的六道家族时钟博物馆，子时即将到来之刻，怜隐将被迫踏上一场扑朔迷离的旅途。",
  },
  {
    title: "殆命睹始的时钟博物馆「Dial：伪月倾覆」",
    shortTitle: "第壹篇章 简介",
    filePath: "jiken_chapter4.txt",
    id: 5,
    summary: "水无波澜的时日，私家侦探八月朔日怜隐接下一桩旧友委托的校园案件。<br>身为班花的夏川梨绘接连数天收到威胁骚扰信息，且住址也已暴露。为维护学生颜面，班主任池田达平委托怜隐对此进行调查。<br><br>在身为受害者同班同学的神山雏子帮助下，案件的可能性很快便被缩小至极易推理的范畴。可原本并非难案的本次私人委托，却因某位曾试图寻求怜隐帮助的富豪雇主意外身亡而逐渐转为错综复杂的悬案。<br>市原近郊的六道家族时钟博物馆，子时即将到来之刻，怜隐将被迫踏上一场扑朔迷离的旅途。",
  },
];
